...
func CreateNewEngine() (x *xorm.Engine, err error) {
	// TODO: Make SetEngine work on local `x`
	...
	if err = x.StoreEngine("InnoDB").Sync2(legacyTables...); err != nil {
		return nil, fmt.Errorf("sync structs to database tables: %v\n", err)
	}
